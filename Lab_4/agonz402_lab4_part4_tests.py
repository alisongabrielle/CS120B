...
tests = [ {'description': 'PINA: 0x04 -> 0x02 -> 0x01 => PORTB: 0x01',
    ...
    {'description': 'PINA: 0x83 => PORTB: 0x00',
    ...
    {'description': 'PINA: 0x04 -> 0x02 -> 0x80 => PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 2 }, 
               {'inputs': [('PINA',0x02)], 'iterations': 2 },
               {'inputs': [('PINA',0x80)], 'iterations': 2 } ],
    'expected': [('PORTB', 0x00)],
    },
    {'description': 'PINA: 0x04 -> 0x06 => PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 2 }, 
               {'inputs': [('PINA',0x06)], 'iterations': 2 }],
    'expected': [('PORTB', 0x00)],
    },
    {'description': 'PINA: 0x04 -> 0x05 => PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 2 }, 
               {'inputs': [('PINA',0x05)], 'iterations': 2 }],
    'expected': [('PORTB', 0x00)],
    },
    {'description': 'PINA: 0x80 => PORTB: 0x00',
    ...
    {'description': 'PINA: 0x80 -> 0x02 -> 0x01 => PORTB: 0x00',
    'steps': [ { 'inputs': [('PINA',0x80)], 'iterations': 2 },
                {'inputs': [('PINA',0x02)], 'iterations': 2 },
