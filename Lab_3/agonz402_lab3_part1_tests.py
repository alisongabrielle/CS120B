...
tests = [ {'description': 'PINA: 0x00, PINB: 0x00 => PORTC: 0x00',
    ...
    {'description': 'PINA: 0x0F, PINB: 0xF0 => PORTC: 0x04',
    ...
    {'description': 'PINA: 0x0C, PINB: 0xC0 => PORTC: 0x08',
    'steps': [ {'inputs': [('PINA',0x0C), ('PINB', 0xC0)], 'iterations': 5 } ],
    'expected': [('PORTC', 0x08)],
    },
    {'description': 'PINA: 0x0F, PINB: 0xFF => PORTC: 0x0C',
    'steps': [ {'inputs': [('PINA',0x0F), ('PINB', 0xFF)], 'iterations': 5 } ],
    'expected': [('PORTC', 0x0C)],
    },
    ]
